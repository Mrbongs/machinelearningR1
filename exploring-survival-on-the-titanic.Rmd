...
train <- read.csv('D:\\R CODING\\R MACHINE LEARNING\\train.csv', stringsAsFactors = FALSE)
test  <- read.csv('D:\\R CODING\\R MACHINE LEARNING\\test.csv', stringsAsFactors = FALSE)
...
write.xlsx(solution, file = 'D:\\R CODING\\R MACHINE LEARNING\\rf_mod_Solution.xlsx', rowNames = FALSE)
```
```{r}
library(caret)

# Assuming 'actual_labels' contains the actual labels for the test set

# Calculate confusion matrix
conf_matrix <- confusionMatrix(prediction, actual_labels)
